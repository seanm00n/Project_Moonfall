...
void UMonsterAttributeSet::OnRep_AttackRange(const FGameplayAttributeData& OldAttackRange)
{
    GAMEPLAYATTRIBUTE_REPNOTIFY(UMonsterAttributeSet, AttackRange, OldAttackRange);
}
