...
#include "CustomDitItHitActorComponent.generated.h"
...
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent, DisplayName = "AC_CustomDitItHit"))
class PROJECT_MOONFALL_API UCustomDitItHitActorComponent : public UActorComponent
{
	GENERATED_BODY()
	...
	bool bHitOtherSocketsAtSameTime = true;
	...
	bool bHitOtherSocketsAtDifferentTime = true;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = KismetTraceSettings, meta = (Tooltip = "Do once Actors to ignore (array)."))
	TArray<AActor*> MyActorsToIgnoreParrying;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = KismetTraceSettings, meta = (Tooltip = "Do once Actors to ignore (array)."))
	TArray<AActor*> MyActorsToIgnoreEvade;
...
//Trace Settings Kismet
	...
	ECustomKismetTraceType MyKismetTraceType = ECustomKismetTraceType::LineTrace;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = KismetTraceSettings, meta = (Tooltip = "In case you trace by channel."))
	TEnumAsByte<ETraceTypeQuery> MyTraceChannel = UEngineTypes::ConvertToTraceType(ECollisionChannel:: ECC_Visibility);
